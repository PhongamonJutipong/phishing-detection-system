...
const TEXT = {
  th: {
    ...
    errorTimeout: 'เครือข่ายช้าเกินไป ระบบรอผลนานเกิน 45 วินาที กรุณาลองใหม่อีกครั้ง',
    errorTooMany: 'ตรวจถี่เกินกำหนด กรุณารอประมาณ 1 นาทีแล้วลองใหม่',
  ...
  en: {
    ...
    errorTimeout: 'The network is too slow: no answer after 45 seconds. Please try again.',
    errorTooMany: 'Too many checks in a short time. Please wait about a minute and try again.',
