...
const TEXT = {
  th: {
    ...
    indicator_no_known_terms: "ไม่พบคำที่อยู่ในคลังคำของโมเดลเลย ผลนี้จึงไม่ได้มาจากการวิเคราะห์เนื้อหา ควรตรวจสอบด้วยตนเอง",
  ...
  en: {
    ...
    indicator_no_known_terms: "No words matched the model vocabulary, so this result is not based on content analysis. Please review manually.",
